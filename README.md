...
| 2 | Metadata tracking | ![os_2](screenshots/2.png) |
| 3 | Bounded-buffer logging | ![os_3](screenshots/3.png) |
| 4 | CLI and IPC | ![os_4](screenshots/4.png) |
| 5 | Soft-limit warning | ![os_5](screenshots/5.png) !
| 6 | Hard-limit enforcement | ![os_6](screenshots/6.png) |
| 7 | Scheduling experiment | ![os_7](screenshots/7.png) |
| 8 | Clean teardown | ![os_8](screenshots/8.png) |
...
The high-priority container finished faster. CFS weight ratio between nice -5 and nice +10 is ~5.8:1, so it received ~5.8x more CPU time under contention.
